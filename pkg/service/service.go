...
type Categories interface {
	GetAll(string) ([]onlinedilerv3.Category, error)
	Get(string, int) (onlinedilerv3.Category, error)
...
func NewService(repos *repository.Repository) *Service {
	return &Service{
		...
		Consignments:    NewConsignmentService(repos.Consignments),
		Discounts:       NewDiscountService(repos.Discounts),
		ClientDiscounts: NewClientDiscountService(repos.ClientDiscounts),
